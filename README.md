...
`npm link` in the module directory and then `npm link <package.name>` in any [Create React App](https://create-react-app.dev) or [Next.JS](https://nextjs.org) repository to develop your components for the browser.
